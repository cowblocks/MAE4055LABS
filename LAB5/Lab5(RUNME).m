...
for i = opIT
    %Send Cmnd To ROBOTO
    MoveArm(operation1(i,1),operation1(i,2),operation1(i,3));
    %pause for a second
    pause(1/length(opIT));
end
%operation2
for i = opIT
    %Send Cmnd To ROBOTO
    MoveArm(operation2(i,1),operation2(i,2),operation2(i,3));
    %pause for a second
    pause(1/length(opIT));
end
%operation3
for i = opIT
    %Send Cmnd To ROBOTO
    MoveArm(operation3(i,1),operation3(i,2),operation3(i,3));
    %pause for a second
    pause(1/length(opIT));
end
%operation4
for i = opIT
    %Send Cmnd To ROBOTO
    MoveArm(operation4(i,1),operation4(i,2),operation4(i,3));
    %pause for a second
    pause(1/length(opIT));
end
%operation 5
for i = opIT
    %Send Cmnd To ROBOTO
    MoveArm(operation5(i,1),operation5(i,2),operation5(i,3));
    %pause for a second
    pause(1/length(opIT));
end
thEnd = 'end'
